"""
Experiment launcher
Main usage: invoke from bash script in runs/ folder
...
def get_parser():
    parser = argparse.ArgumentParser(description='Image classification using different optimizers')
    ...
    parser.add_argument('--l2_reg_loss', action='store_true', help='whether to integrate L2 regularization inside the loss function')
    parser.add_argument('--l2_reg', type=float, default=0.0001, help='value of L2 regularization')
...
if __name__ == "__main__":
    ...
    if args.use_wandb:
        ...
        # job type for the configuration specifics, and within that the runs should only differ by the
        # random seed.
